...
// ========== CO-OP SENKRONİZASYONU İÇİN DETERMİNİSTİK RNG ==========
let rngSeed = 12345;
...
function resetLevel() {
    ...
    // ✅ SEED'İ SIFIRLA (level'e göre farklı olsun ama iki tarafta aynı olsun)
    resetRNG(12345 + level);
